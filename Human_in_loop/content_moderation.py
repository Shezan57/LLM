...
from Human_in_loop.breakpoint_agent import user_approval
...
builder.add_node("creat_draft",create_draft)
...
if user_approval.lower() == "yes":
    ...
    memory.update({"draft_content":update_draft}) # update memory with new content
